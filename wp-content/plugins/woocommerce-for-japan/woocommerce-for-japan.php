 ...
 * @author Artisan Workshop
 */
//use ArtisanWorkshop\WooCommerce\PluginFramework\v1_0_6 as Framework;
...
class WooCommerce4jp{
	...
	public function __construct() {
		...
		define( 'WC4JP_FRAMEWORK_VERSION', '1.0.6' );
	}
	/**
	...
	private function includes() {
		//load framework
		if ( ! class_exists( '\\ArtisanWorkshop\\WooCommerce\\PluginFramework\\v1_0_6\\WC4JP_Plugin' ) ) {
			include_once( plugin_dir_path( __FILE__ ).'includes/wc4jp-framework/class-wc4jp-framework.php' );
		}
		...
		// Address Setting
		if(!get_option('wc4jp-no-ja')) include_once( 'includes/class-wc-address-field-4jp.php' );
		// Delivery Setting
		include_once( 'includes/class-wc-delivery-4jp.php' );
...
register_deactivation_hook( __FILE__, 'wc4jp_deactivate' );
function wc4jp_deactivate(){
	flush_rewrite_rules();
}